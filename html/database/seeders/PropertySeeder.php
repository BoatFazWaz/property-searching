...
class PropertySeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // High-quality luxury real estate images from Unsplash
        $propertyImages = [
            'condo' => [
        ...
        foreach ($properties as $property) {
            ...
            $images = isset($propertyImages[$type]) ? $propertyImages[$type] : $propertyImages['default'];
            
            // Add location-specific images if available
            if (!empty($property->geo->province) && isset($locationImages[$property->geo->province])) {
                $images = array_merge($images, $locationImages[$property->geo->province]);
            }
            
            // Use property ID to select a consistent image
            $imageIndex = $property->id % count($images);
            ...
            Property::create([
                ...
                'photo_thumb' => $imageUrl,
                'photo_search' => $imageUrl,
                'photo_full' => $imageUrl,
            ]);
        }
    }
